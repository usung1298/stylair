// src/assets/outfits.ts
import { Outfit } from '../types';

export const OUTFITS: Outfit[] = [
  {
    id: 1, emoji: '🧥',
    title: '오버핏 데님 룩', brand: "ZARA × Levi's",
    price: '₩182,000', season: '봄', style: '캐주얼',
    tags: ['데님', '오버핏', '봄'],
    desc: '클래식한 오버핏 데님 재킷과 와이드 팬츠의 조화. 흰 티셔츠로 깔끔함을 더했습니다. 봄 산책이나 가벼운 만남에 완벽한 룩입니다.',
    items: [
  ...
  {
    id: 2, emoji: '👗',
    title: '플로럴 원피스 룩', brand: 'H&M',
    price: '₩129,000', season: '여름', style: '캐주얼',
    tags: ['원피스', '플로럴', '여름'],
  ...
  {
    id: 3, emoji: '🧣',
    title: '레이어드 니트 룩', brand: 'COS',
    price: '₩245,000', season: '가을', style: '미니멀',
    tags: ['니트', '레이어드', '가을'],
  ...
  {
    id: 4, emoji: '🥾',
    title: '레이어드 겨울 룩', brand: 'Moncler × Arket',
    price: '₩389,000', season: '겨울', style: '캐주얼',
    tags: ['패딩', '겨울', '레이어드'],
  ...
  {
    id: 5, emoji: '👔',
    title: '모던 포멀 룩', brand: 'Theory',
    price: '₩320,000', season: '봄', style: '포멀',
    tags: ['포멀', '수트', '비즈니스'],
  ...
  {
    id: 6, emoji: '🎽',
    title: '스트릿 스포티 룩', brand: 'Nike × Supreme',
    price: '₩198,000', season: '여름', style: '스트릿',
    tags: ['스트릿', '스포티', '여름'],
  ...
  {
    id: 7, emoji: '🧤',
    title: '빈티지 레트로 룩', brand: 'Vintage Shop',
    price: '₩155,000', season: '가을', style: '미니멀',
    tags: ['빈티지', '레트로', '가을'],
  ...
  {
    id: 8, emoji: '👒',
    title: '리조트 썸머 룩', brand: 'Sundek × Vans',
    price: '₩135,000', season: '여름', style: '캐주얼',
    tags: ['여름', '리조트', '바캉스'],
